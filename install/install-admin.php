...
<p>本系统在yii2的框架基础上开发，你可以在接下来的
    配置中完成对于数据库的配置，并且选择导入的数据脚本，之后就可以开始使用我们的平安社区系统。</p>
<h2>环境需求：</h2>
<p>配置本系统需要的最低环境要求：</p>
<p>PHP >= 5.6</p>
<p>MySQL >= 7.0</p>
...
<form id="setup" method="post" novalidate="novalidate">
    <table class="form-table" role="presentation">
        <tr>
            ...
            <td><input name="admin_account" type="text" id="weblog_title" size="25" value="000000000000000000"
                       readonly="readonly"/>
                <p>网站的后台超级管理员账号，18个0，拥有后台管理的最高权限，不可编辑</p>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <input name="admin_password" type="password" id="user_login" size="25"
                       value="<?= isset($_POST['admin_password']) ? $_POST['admin_password'] : '' ?>"
                       aria-required="true" oninput="<?php
